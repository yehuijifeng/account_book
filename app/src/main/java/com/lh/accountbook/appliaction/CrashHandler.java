...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    private static class CrashHandlers {
        private static CrashHandler mvpAppliaction = new CrashHandler();
    }
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        LogUtils.e(result);
        try {
            String fileName = "crash-" + DateUtils.getNow() + "-" + System.currentTimeMillis() + ".log";
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                /**
                 * 这里换成自定义路径
                 */
                String path = AppConstant.APP_PATH_LOG;
            ...
            LogUtils.e("insert file error!"+e);
        }
        return null;
    }
