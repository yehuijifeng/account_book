...
public class ResidentOneService extends Service {
     ...
     * *启动Service2
     */
    private StrongService startS2 = new StrongService() {
        @Override
        public void stopService() {
            Intent i = new Intent(getBaseContext(), ResidentTwoService.class);
    ...
    public void onCreate() {
        //Toast.makeText(ResidentOneService.this, "Service1 onCreate...", Toast.LENGTH_SHORT).show();
    ...
    private void keepService2() {
        if (!ResidentUtil.isProessRunning(ResidentOneService.this, Process_Name)) {
